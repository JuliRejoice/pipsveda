    ...
    return (
        <div className={styles.coursesPagealignment}>
            ...
            <div className={styles.tabAlignment}>
                <button className={styles.activeTab}>Video Courses</button>
