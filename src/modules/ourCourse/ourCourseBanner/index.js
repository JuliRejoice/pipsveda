  ...
  useEffect(() => {
    ...
    animate([
      ...
      [
        "img",
        { opacity: 1, scale: 1 },
        { duration: 0.8, ease: "easeOut", at: 0.2 },
      ],
    ]);
  }, [isInView, animate]);
          ...
          <div className={styles.grid}>
            ...
            <div className={styles.griditems}>
              <div className={styles.image}>
                {course === "live" && (
                  <img src={LiveCardImage} alt="Live Online Classes" />
                )}
                {course === "recorded" && (
                  <img src={PreCardImage} alt="Pre Recorded Courses" />
                )}
                {course === "physical" && (
              ...
              <motion.div className={styles.blackButton} {...buttonFloat}>
                <Button text="Five Veda Trading" black />
              </motion.div>
